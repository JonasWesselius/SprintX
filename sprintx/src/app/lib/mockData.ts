...
export type Subject = "metaal" | "hout" | "bouw" | "at";
...
export const mockProjects: Record<string, Project> = {
  ...
  16: {
    id: "16",
    title: "Basis Constructie",
    description: "Ontwerp en bouw een basis constructieproject",
    status: "completed" as const,
    grade: 85,
    studentWork: "Complete constructie van een kleine overkapping met verschillende verbindingen",
    teacherFeedback: "Nette uitvoering en goede toepassing van constructieprincipes",
    exampleWork: "Voorbeelden van constructietekeningen en verbindingstechnieken",
    yearLevel: 3,
    subject: "bouw"
  },
  17: {
    id: "17",
    title: "Bekistingen",
    description: "Leer verschillende bekistingstechnieken",
    status: "in_progress" as const,
    exampleWork: "Voorbeelden van bekistingen en hun toepassingen",
    yearLevel: 2,
    subject: "bouw"
  },
  18: {
    ...
    description: "Leer motordiagnose en onderhoud uitvoeren",
    status: "completed" as const,
    grade: 90,
    studentWork: "Complete diagnose en onderhoudsbeurt van een moderne benzinemotor",
    teacherFeedback: "Uitstekend inzicht in diagnosetechnieken en probleemoplossing",
    exampleWork: "Voorbeelden van diagnoseprocessen en onderhoudsschema's",
    yearLevel: 3,
    subject: "at"
  },
  19: {
    id: "19",
    title: "Basis Autotechniek",
    description: "Leer de basisprincipes van autotechniek",
    status: "in_progress" as const,
    exampleWork: "Basiskennis van autosystemen en onderhoudstechnieken",
    yearLevel: 2,
    subject: "at"
  }
};
...
export const mockStudentProjects: Record<StudentId, string[]> = {
  ...
  1: ["1", "2", "14", "17", "15", "19"],          // 2 metal, 2 wood, 1 bouw, 1 at
  2: ["2", "15", "17", "19", "1", "14"],          // 1 metal, 2 wood, 1 bouw, 1 at
  3: ["1", "14", "17", "19", "2", "15"],          // 1 metal, 2 wood, 1 bouw, 1 at
  4: ["2", "15", "17", "19", "1", "14"],          // 1 metal, 2 wood, 1 bouw, 1 at

  // 3rd year students (current year + previous year projects)
  5: ["3", "4", "16", "18",                       // Current year: advanced projects
      "1", "2", "14", "17"],                      // Previous year: basic projects
  6: ["3", "16", "18", "4",                       // Current year: advanced projects
      "1", "14", "17", "15"],                     // Previous year: basic projects
  7: ["4", "16", "18", "3",                       // Current year: advanced projects
      "2", "15", "17", "14"],                     // Previous year: basic projects
  ...
  9: ["5", "6", "16", "18",                       // Current year: final projects
      ...
      "1", "2", "17"],                            // 2nd year: basic projects
